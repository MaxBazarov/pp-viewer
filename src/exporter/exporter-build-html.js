    ...
    menu.push(
        {
            ID: "", items: [
                ...
                { ID: "menu_comments_viewer", label: "Comments", icon: "icAnnotation", key: "C", onclick: "viewer.commentsViewer.toggle();", on: options.upoading && es.enableComments && ec.menuCommentsEnabled },
