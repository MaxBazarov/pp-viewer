...
class ExpViewer extends AbstractViewer
{
    ...
    _buildContentPages()
    {
        ...
        html += `</div>`
        //
        let contentDiv = byId("#xp_viewer_content");
    ...
    _buildContentWidgets()
    {
        ...
        html += `</div>`
        //
        let contentDiv = byId("exp_viewer_content");
        contentDiv.innerHTML = html;
    }
    ...
    goWidget(widgetName)
    {
        const pagesDiv = byId("exp-widget-" + widgetName);
        const widgetsDiv = pagesDiv.querySelector(".page")
        toogleVisEl(widgetsDiv);
    }
    ...
    highlightWidget(widgetName)
    {
        ...
        {
            byId("exp-filter-exp").checked = false;
            byId("exp-filter-all").checked = true;
