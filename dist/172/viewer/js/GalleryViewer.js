...
function handleWheel(e)
{
    if (e.ctrlKey)
    {
        e.preventDefault();
        //
        let newZoom = viewer.galleryViewer.zoom - e.deltaY / 100
...
class GalleryViewer extends AbstractViewer
{
    ...
    buildContent_Group(group)
    {
        var divGroup = $('<div/>', {
            ...
            style: `background:${group.backColor};left:0px;top:0px;width:200%;height:0px;`,
        });
        group.jdiv = divGroup
    ...
    positionContent_Page(page)
    {
        ...
        if (page.label_jdiv)
        {
            let top = page.globalTop - this.zoom < 0.5 ? GALLERY_FRAME_LABEL_HEIGHT / this.zoom : GALLERY_FRAME_LABEL_HEIGHT
            ...
            page.label_div.style.display = this.zoom < 0.5 ? "none" : "block"
        }
