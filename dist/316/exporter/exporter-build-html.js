...
function buildMainHTML_NavigationIcons(options, es)
{
    return `
    <div class="containerSVG">
        ...
        <svg class="svgIcon">
            ...
            <symbol ID="icClose16" viewBox="0 0 16 16">
                <path d="M12.0334 3.25992C12.2286 3.06481 12.5452 3.06471 12.7404 3.25992C12.9354 3.45515 12.9354 3.77176 12.7404 3.96695L8.70718 8.00015L12.7404 12.0334C12.9353 12.2286 12.9355 12.5452 12.7404 12.7404C12.5452 12.9355 12.2286 12.9353 12.0334 12.7404L8.00015 8.70718L3.96695 12.7404C3.77176 12.9355 3.45517 12.9354 3.25992 12.7404C3.06469 12.5452 3.06475 12.2286 3.25992 12.0334L7.29312 8.00015L3.25992 3.96695C3.06466 3.77169 3.06466 3.45518 3.25992 3.25992C3.45518 3.06471 3.77171 3.06467 3.96695 3.25992L8.00015 7.29312L12.0334 3.25992Z" fill="black" />
            </symbol>
            <symbol ID="icDelete16" viewBox="0 0 16 16">
                <path d="M6.50024 6.07727C6.77627 6.0774 7.00024 6.30121 7.00024 6.57727V11.5773L6.99048 11.6779C6.94397 11.9057 6.74185 12.0772 6.50024 12.0773C6.25855 12.0773 6.05655 11.9058 6.01001 11.6779L6.00024 11.5773V6.57727C6.00024 6.30113 6.2241 6.07727 6.50024 6.07727Z" fill="black" />
                <path d="M9.50024 6.07727C9.77627 6.0774 10.0002 6.30121 10.0002 6.57727V11.5773C10.0002 11.8533 9.77627 12.0771 9.50024 12.0773C9.2241 12.0773 9.00024 11.8534 9.00024 11.5773V6.57727C9.00024 6.30113 9.2241 6.07727 9.50024 6.07727Z" fill="black" />
                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.00024 0.577271C10.1048 0.577294 11.0002 1.47272 11.0002 2.57727V3.07727H13.5002L13.4895 3.32727H13.7502C14.0264 3.32729 14.2502 3.55114 14.2502 3.82727C14.2502 4.1034 14.0264 4.32725 13.7502 4.32727H13.4485L13.1204 12.2023L13.093 12.4991C12.8868 13.9625 11.6301 15.0772 10.1223 15.0773H5.87817L5.58032 15.0626C4.20746 14.9273 3.10002 13.8651 2.90747 12.4991L2.88013 12.2023L2.552 4.32727H2.25024C1.97412 4.32725 1.75024 4.1034 1.75024 3.82727C1.75024 3.55114 1.97412 3.32729 2.25024 3.32727H2.51099L2.50024 3.07727H5.00024V2.57727C5.00024 1.4727 5.89567 0.577271 7.00024 0.577271H9.00024ZM3.55298 4.32727L3.87915 12.1603C3.92379 13.2315 4.80599 14.0773 5.87817 14.0773H10.1223C11.1944 14.0772 12.0767 13.2315 12.1213 12.1603L12.4475 4.32727H3.55298ZM7.00024 1.57727C6.44796 1.57727 6.00024 2.02499 6.00024 2.57727V3.07727H10.0002V2.57727C10.0002 2.025 9.55251 1.57729 9.00024 1.57727H7.00024Z" fill="black" />
            </symbol>
            <symbol ID="icEdit16" viewBox="0 0 16 16">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M10
            </symbol>
             <svg ID="icSignOut16" viewBox="0 0 16 16" width="16" height="16">
                <path d="M9.50012 4.5C9.50012 4.7761 9.27621 4.99993 9.00012 5C8.72398 5 8.50012 4.77614 8.50012 4.5L8.50012 4C8.50012 2.96439 7.71284 2.11306 6.70422 2.01074L6.50012 2L4.00012 2C2.89555 2 2.00012 2.89543 2.00012 4L2.00012 12C2.00012 13.1046 2.89555 14 4.00012 14L6.50012 14C7.60463 13.9999 8.50012 13.1045 8.50012 12L8.50012 11.5C8.50012 11.2239 8.72398 11 9.00012 11C9.27621 11.0001 9.50012 11.2239 9.50012 11.5L9.50012 12L9.49622 12.1543C9.41591 13.7394 8.10517 14.9999 6.50012 15L4.00012 15C2.39502 15 1.08434 13.7394 1.00403 12.1543L1.00012 12L1.00012 4C1.00012 2.39489 2.26068 1.08421 3.84583 1.00391L4.00012 1L6.50012 1C8.15692 1.00007 9.50012 2.34319 9.50012 4L9.50012 4.5ZM14.6681 7.72461C14.7961 7.91864 14.7744 8.18269 14.6036 8.35352L12.1036 10.8535C11.9084 11.0487 11.5919 11.0486 11.3966 10.8535C11.2014 10.6583 11.2014 10.3417 11.3966 10.1465L13.0431 8.5L4.75012 8.5C4.47403 8.49996 4.25014 8.2761 4.25012 8C4.25014 7.7239 4.47403 7.50004 4.75012 7.5L13.0431 7.5L11.3966 5.85352C11.2014 5.65826 11.2014 5.34173 11.3966 5.14648C11.5919 4.95133 11.9084 4.95131 12.1036 5.14648L14.6036 7.64648L14.6681 7.72461Z" fill="black" />
            </svg>
            ...
            <symbol ID="icVersions" viewBox="0 0 24 24">
             ...
             <symbol ID="icNotes" viewBox="0 0 24 24">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M18.75 18C18.75 19.2426 17.7426 20.25 16.5 20.25H7.5C6.25736 20.25 5.25 19.2426 5.25 18L5.25 6C5.25 4.75736 6.25736 3.75 7.5 3.75L11.636 3.75C12.2328 3.75 12.8051 3.98705 13.227 4.40901L18.091 9.27297C18.5129 9.69493 18.75 10.2672 18.75 10.864V18ZM19.682 7.68198C20.5259 8.52589 21 9.67049 21 10.864L21 18C21 20.4853 18.9853 22.5 16.5 22.5H7.5C5.01472 22.5 3 20.4853 3 18V6C3 3.51472 5.01472 1.5 7.5 1.5H11.636C12.8295 1.5 13.9741 1.97411 14.818 2.81802L19.682 7.68198ZM12 7.5C12.6213 7.5 13.125 8.00368 13.125 8.625V12.75C13.125 13.3713 12.6213 13.875 12 13.875C11.3787 13.875 10.875 13.3713 10.875 12.75V8.625C10.875 8.00368 11.3787 7.5 12 7.5ZM13.5 16.875C13.5 17.7034 12.8284 18.375 12 18.375C11.1716 18.375 10.5 17.7034 10.5 16.875C10.5 16.0466 11.1716 15.375 12 15.375C12.8284 15.375 13.5 16.0466 13.5 16.875Z" />
            </symbol>
            <symbol ID="icNotesWarning" viewBox="0 0 24 24">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M18.75 18C18.75 19.2426 17.7426 20.25 16.5 20.25H7.5C6.25736 20.25 5.25 19.2426 5.25 18L5.25 6C5.25 4.75736 6.25736 3.75 7.5 3.75L11.636 3.75C12.2328 3.75 12.8051 3.98705 13.227 4.40901L18.091 9.27297C18.5129 9.69493 18.75 10.2672 18.75 10.864V18ZM19.682 7.68198C20.5259 8.52589 21 9.67049 21 10.864L21 18C21 20.4853 18.9853 22.5 16.5 22.5H7.5C5.01472 22.5 3 20.4853 3 18V6C3 3.51472 5.01472 1.5 7.5 1.5H11.636C12.8295 1.5 13.9741 1.97411 14.818 2.81802L19.682 7.68198ZM12 7.5C12.6213 7.5 13.125 8.00368 13.125 8.625V12.75C13.125 13.3713 12.6213 13.875 12 13.875C11.3787 13.875 10.875 13.3713 10.875 12.75V8.625C10.875 8.00368 11.3787 7.5 12 7.5ZM13.5 16.875C13.5 17.7034 12.8284 18.375 12 18.375C11.1716 18.375 10.5 17.7034 10.5 16.875C10.5 16.0466 11.1716 15.375 12 15.375C12.8284 15.375 13.5 16.0466 13.5 16.875Z" fill="#FFB70A" />
            </symbol>
        </svg>      
    </div>
    `
...
async function buildMainHTML_JS(options, es, verPostfix, srcPath)
{
    ...
    } else
    {
        ...
        {
            s += `
                <script type="text/javascript" src="../../.team.js?1" charset="UTF-8"></script>
            `;
        }
    }
    return s;
...
async function buildMainHTML_Images(options, es, verPostfix, srcPath)
{
    console.log("buildMainHTML_Images");
    if (options.images)
        return `
            <script>
                const IMAGES =     
                    ${JSON.stringify(options.images, null, "\n")}
                ;
            </script>`
    else
        return "";
...
async function buildMainHTML(options, es)
{
    ...
    menu.push(
        {
            ID: "", items: [
                { ID: "symbols", label: "Handoff", icon: "icElementInspector", key: "M", onclick: "viewer.symbolViewer.toggle();", on: es.inspectorEnabled && es.menuHandoffEnabled },
        ...
        },
        {
            ...
            ID: "", items: [
                ...
                { ID: "menu_info_viewer", label: "Changes history", icon: "icList", key: "V", onclick: "viewer.infoViewer.toggle();" },
            ],
            on: options.uploading && es.menuVersionsEnabled === true && es.useCloudVersions === true,
        },
        {
            ID: "", items: [
    ...
    menu.forEach(function (group, index)
    {
        ...
        //
        if (index > 0 && (menu[index - 1].label === undefined || group.label === undefined) && shownGroup) s += "<hr>\n"
    ...
    s += `
                            ...
                            <div class="navCenter">
                                ...
                                <div class="navRight">
                                   ...
                                   <div ID="pageNotes" onclick="notesViewer.toggle(); return false;" class="btnMenu hidden">
                                        <svg class="svgIconWarning">
