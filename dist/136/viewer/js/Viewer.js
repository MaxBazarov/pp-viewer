...
class Viewer
{
    ...
    convFigmaURL(url)
    {
        ...
        xhr.open("POST", `../../../_private/tools.php?cmd=convertFigmaURL&tid=${this.teamID}`, false);
    ...
    _updateLinksState(showLinks = undefined, div = undefined)
    {
        ...
        const divs = div ? [div] : (showLinks & this.currentPage.type === 'modal' ? [$('#content-modal')] : [$('#content-modal'), $('#content')])
        if (showLinks)
