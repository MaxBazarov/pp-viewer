...
class GalleryViewer extends AbstractViewer
{
    ...
    initialize(force = false)
    {
        ...
        document.querySelector("#gallery-header-container #label #screensamount").innerHTML = this.pages.length + " screens";
        document.querySelector("#gallery-header-container #label #title").innerHTML = story.title
        this.inited = true
