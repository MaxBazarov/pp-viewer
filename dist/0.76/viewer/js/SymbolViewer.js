    ...
    _showLayerDimensions(layer)
    {
        ...
        info += `
            ...
            <div class="block twoColumn">
                <div>
                    <span class="label">X </span>${Math.round(frameX)}
                </div>
                <div>
                    <span class="label">Y </span>${Math.round(frameY)}
                </div>
            </div>
            <div class="block twoColumn">
                <div>
                    <span class="label">W </span>${Math.round(frameWidth)}
                </div>
                <div>
                    <span class="label">H </span>${Math.round(frameHeight)}
                </div>
            </div>
        `
        return info
