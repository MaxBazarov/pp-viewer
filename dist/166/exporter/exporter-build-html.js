        ...
        <div ID="gallery-header-container">
            ...
            <div ID="right">
                <div class="checkbox-container">
                    ...
                    <span class="checkbox-label">Map (M)</span>
                </div>
                <div class="checkbox-container">
                    ...
                    <span class="checkbox-label">All links (L)</span>
                </div>
                <div ID="map-controls">
                    <select onchange="viewer.galleryViewer.mapZoomChanged(this.value)">
                        <option selected value="opt">Optimal zoom</option>
                        <option value="10">Zoom to 10%</option>
                        <option value="50">Zoom to 50%</option>
                        <option value="100">Zoom to 100%</option>
                        <option value="200">Zoom to 200%</option>
                    </select>
                </div>
